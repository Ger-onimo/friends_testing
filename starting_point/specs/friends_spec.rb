...
class TestFriends < MiniTest::Test
  ...
  # (e.g. the function favourite_tv_show
  #(@person2) should return the string "Baywatch")
...
#   # (e.g. the function add_friend(@person2, "Scrappy-Doo")
#   #should add Scrappy-Doo to the friends.)
#   # (hint: This function should not return anything.
#   # After the function call, check for the length of the friends
#   #array to test it!)
#
...
def test_loan_monies
  loan_monies(@person4, @person5, 10)
  result = @person4[:monies]
